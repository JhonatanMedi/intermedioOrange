...
public class DefinitionsSteps {
    ...
    public void dilligenciarAddUser(String sheetName, Integer rowNumber) throws IOException, InvalidFormatException {
        this.adminPage = new AdminPage(driver);
        ExcelReader excelReader = new ExcelReader();
        List<Map<String, String>> testData = excelReader.getData("src/test/resources/testData/DataAdUuser.xlsx", sheetName);
        ...
        adminPage.dilligenciarAddUser(useRole, employeeName, userName, password, confirmPassword);
    }
